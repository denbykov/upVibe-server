export class Config {
  ...
  constructor(configEnv: JSON.JSONObject, configJson: JSON.JSONObject) {
    ...
    this.apiAccessTokenSecret =
      configEnv.API_ACCESS_TOKEN_SECRET || configJson.API_ACCESS_TOKEN_SECRET;
    this.apiRefreshTokenSecret =
      configEnv.API_REFRESH_TOKEN_SECRET || configJson.API_REFRESH_TOKEN_SECRET;
    ...
    this.dbMax = parseInt(configEnv.DB_MAX) || parseInt(configJson.DB_MAX);
  }
}
