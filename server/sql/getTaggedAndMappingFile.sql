SELECT
  ...
  tm.title as file_mapping_title,
  tm.artist as file_mapping_artist,
  tm.album as file_mapping_album,
  tm.picture as file_mapping_picture,
  tm.year as file_mapping_year,
  tm.track_number as file_mapping_track_number
FROM
  files as f
